...
public class Server extends JFrame {
    ...
    public void startRunning() {
        try {
            server = new ServerSocket(1234, 100); //1234 is a dummy port for testing, this can be changed. The 100 is the maximum people waiting to connect.
            while (true) {
                try {
